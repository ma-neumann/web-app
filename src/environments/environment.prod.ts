...
export const environment = {
  ...
  baseApiUrl: JSON.parse(localStorage.getItem('mifosXServerURL')) || 'https://fineract.yneumann.de',  // For connecting to server running elsewhere update the base API URL
